    ...
    return (
        <div className="mx-auto container xl:px-20 lg:px-12 sm:px-6 px-4 px-4 py-12">
           ...
           <img src={logo} className='w-48'/>
                ...
                <Link to="create-post">
                    <p className="hover:text-gray-500 text-base cursor-pointer leading-4 text-gray-800">Genrate your thought</p>
                    </Link>
                ...
                <div className="flex items-center mt-6">
                    <p className="text-base leading-4 text-gray-800">
                        2023 <span className="font-semibold">Ai-Magin</span>
                    </p>
